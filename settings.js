...
global.email = 'vijitharanawakagegmail.com'
global.github = 'https://github.com/sandeshTech/sandesh-MD'
global.location = 'Srilanka Colombo'
global.packname = '𝚜𝚝𝚒𝚌𝚔𝚎𝚛 𝚋𝚢';
global.author = '𝙎𝘼𝙉𝘿𝙀𝙎𝙃 𝙈𝘿';
global.mess = {
...
global.owner = [process.env.OWNER_NUMBER] || ['94741259325'] // Owner number , (අයිතිකරුගේ නම්බර් එක )

module.exports = {    
SESSION_ID: process.env.SESSION_ID || VAJIRA-MD:NotedComes',
...
FOOTER: process.env.FOOTER ||  '©ＳＡＮＤＥＳＨ - ＭＤ - Ｖ1',
